...
- **Interactive Frontend**: Streamlit-based web interface for easy resume and interview preparation
...
```bash
cd SchoolOfAI/Official/soai-24-resumecoach
```
...
- `codellama` - Specialized for technical roles and code-related interviews

## Data Storage

### Memory Store

Coaching sessions and agent interactions are stored in:
...
- Monitor memory usage with large coaching sessions
